...
const StyledCustomCardContent = styled(Flex)`${({theme}) => `
  flex-grow: 1;
  gap: 35px;
      ...
      <Container size="lg">
        <Grid columns={2} gap={200}>
          <div>
            ...
            <p>ORIGYN Art is a blockchain community created exclusively for the art market. We create NFTs of physical art and enable fractionalized ownership of art masterpieces, which can be traded digitally.</p>
            <br/>
            <p>By tokenizing physical masterpieces, the dream of democratized and fractionalized ownership is now possible in the art world.</p>
            <br/>
            <br/>
          ...
          <StyledCustomCardContent>
            ...
            <Flex flexFlow="column" justify="space-between" fullHeight gap={20}>
              <Flex flexFlow="column" gap={10}>
                <p>For the first time, ownership of masterpieces is available to anyone.</p>
                <p>ORIGYN Art lets you invest in digital shares in artworks by renowned artists and trade these shares freely on the marketplace.</p>
              </Flex>
              <CustomButton bordered primary>Buy art</CustomButton>
            </Flex>
          </StyledCustomCardContent>
        </Card>
        <Card flexFlow="column" padding="25px 30px">
          ...
          <StyledCustomCardContent>
            ...
            <Flex flexFlow="column" justify="space-between" fullHeight gap={20}>
              <Flex flexFlow="column" gap={10}>
                <p>Are you a Gallerist or Art Collector? The NFT phenomenon opens the art world to millions of new investors.</p>
                <p>Get in touch with our team of experts to get started.</p>
              </Flex>
              <CustomButton bordered primary>Sell art</CustomButton>
            </Flex>
          </StyledCustomCardContent>
        </Card>
      </Grid>
