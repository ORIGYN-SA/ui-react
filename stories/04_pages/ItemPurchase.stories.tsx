...
import Checkbox from "../../components/interface/Inputs/CheckboxInput";
...
const Template: Story = (args) => {
  ...
  const stepsConfig = [
    ...
    },
    {
      ...
      description: (
        <>
          Transfer ICP from your balance to ORIGYN Art.
          <br />
          The transaction can take up to 2 days.
        </>
      ),
      content: (
        <Flex flexFlow="column">
  ...
  const [StepperHeader, StepperContent, step, setStep] = useStepper(
    stepsConfig
  );
        ...
        {isItemPurchased ? (
          <Flex flexFlow="column">
            <Flex gap={20} align="center">
              <CheckIcon fill="#50AA3E" />
              <h2>ICP Sent</h2>
            </Flex>
            <br />
            <p>
              Payment has been send to the seller’s wallet. The transaction can
              take up to 2 days.
            </p>
            <br />
            <p>
              Once the payment has been received, the NFT will be transferred to
              your Portfolio.
            </p>
            <br />
            <p>
              <b>Check your portfolio for status updates.</b>
            </p>
            <br />
            <br />
            <br />
